 ...
 */
package com.scu.holden.protectooth.widget;
...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public void setTouchHandler(Handler thandler){
		touchhandler = thandler;
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			float dx = formalX - mLastMotionX;
			Log.e("duolala9","move"+dx);
			//当用户点击图片时
			if (dx == 0.0) {
				//发送消息打开页面（当前页数）
				Message msg = new Message();
				msg.arg1 = getSelectedItemPosition()%3;
